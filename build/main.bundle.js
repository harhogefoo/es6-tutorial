...
document.getElementById('calcBtn').addEventListener('click', function () {
    ...
    var _mortage$calculateAmo = mortage.calculateAmortization(principal, years, rate),
        monthlyPayment = _mortage$calculateAmo.monthlyPayment,
        monthlyRate = _mortage$calculateAmo.monthlyRate,
        amortization = _mortage$calculateAmo.amortization;
...
var calculateAmortization = exports.calculateAmortization = function calculateAmortization(principal, years, rate) {
  ...
  for (var y = 0; y < years; y++) {
    ...
    for (var m = 0; m < 12; m++) {
      var interestM = balance * monthlyRate; // Interest payment for monthly m
      var principalM = monthlyPayment - interestM; // Principal payment for mmonthly
